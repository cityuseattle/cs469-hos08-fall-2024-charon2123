...
def activitySelection(start, finish):
    ...
    so that you can get the correct index even after sorting'''
    ...
    # 'answer to store the selected activities index
    i, answer = 0, [actID[0]]
...
print(activitySelection([0,3,4,2,5,3,9,11,10],
                        [3,4,6,8,9,12,13,14,15]))   

# Test case #2: output = [0, 1, 3, 4]
print(activitySelection([1, 3, 0, 5, 8, 5],
                        [2, 4, 6, 7, 9, 9]))

# Test case #3: output = [1, 4, 3]
print(activitySelection([4, 0, 1, 1, 3],
                        [6, 2, 3, 6, 4]))